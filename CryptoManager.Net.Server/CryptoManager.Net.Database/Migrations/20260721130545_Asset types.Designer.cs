...
namespace CryptoManager.Net.Database.Migrations
{
    ...
    [Migration("20260721130545_Asset types")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoManager.Net.Database.Models.Asset", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int?>("AssetSubType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CryptoManager.Net.Database.Models.ExchangeAsset", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("AssetType"), new[] { "Value", "Volume", "ChangePercentage", "Asset" });

                    b.HasIndex("Exchange");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Exchange"), new[] { "Value", "Asset" });

                    b.HasIndex("Asset", "AssetType");

                    b.HasIndex("Exchange", "Asset");

                    b.ToTable("ExchangeAssets");
                });
            ...
            modelBuilder.Entity("CryptoManager.Net.Database.Models.ExchangeSymbol", b =>
                {
                    ...
                    b.Property<string>("BaseAssetExchangeId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<int?>("BaseAssetSubType")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("QuoteAssetExchangeId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("QuoteAssetSubType")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BaseAssetExchangeId");

                    b.HasIndex("QuoteAsset");

                    b.HasIndex("UpdateTime");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("UpdateTime"), new[] { "Exchange", "BaseAsset" });
            ...
            modelBuilder.Entity("CryptoManager.Net.Database.Models.UserUpdate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
